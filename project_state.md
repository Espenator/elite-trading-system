...
- **Status**: Active development, Phase 1 implementation — v4.0.0
...
## LATEST CHANGES (March 7, 2026) — v4.0.0

### Backend Audit Fix (CI green, weight conflict resolved, outcome tracking wired)
- Fixed CI: test_app_version now reads settings.APP_VERSION (was hardcoded "3.2.0")
- Fixed CI: test_kelly_rejects_when_equity_unavailable MagicMock TypeError
- Added outcome.resolved to MessageBus.VALID_TOPICS
- Resolved weight learning conflict: feedback_loop now delegates to WeightLearner
- Added endpoint coverage verification test (test_endpoint_coverage.py)
- Agent count corrected: 17 agents in 7 stages (not 13)

## Previous: v3.4.0 (March 6, 2026)
...
- Council: 17 agents + arbiter + runner + CouncilGate + WeightLearner (fully connected to pipeline)
