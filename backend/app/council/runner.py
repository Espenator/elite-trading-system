...
async def run_council(
    ...
    # Store hypothesis vote in blackboard for backward compatibility
    hypothesis_vote = next((v for v in stage3 if v.agent_name == "hypothesis"), None)
    if hypothesis_vote:
        blackboard.hypothesis = hypothesis_vote.to_dict()
