...
MAX_PENDING = 500  # Hard cap on buffered news items between poll intervals
...
class NewsScout(BaseScout):
    ...
    async def _on_news_event(self, data: dict) -> None:
        ...
        # Trim to hard cap to prevent unbounded growth between poll intervals
    ...
    async def scout(self) -> List[DiscoveryPayload]:
        ...
        try:
            ...
            items = await agg.get_news(limit=10)
