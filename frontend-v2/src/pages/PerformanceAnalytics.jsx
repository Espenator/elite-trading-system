  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Last updated 1 minute ago"
      >
      ...
      <Card title="Portfolio Performance">
        ...
        <div className="h-48 bg-dark/50 rounded-xl border border-secondary/50 flex items-end px-4 pb-4 gap-1">
          {[
            30, 32, 35, 33, 38, 40, 42, 45, 44, 48, 50, 52, 55, 58, 56, 60, 62,
            65, 68, 72, 75, 78, 80, 85,
          ].map((v, i) => (
            <div
              key={i}
        ...
        <Card title="ML Insights">
          <div className="space-y-3">
            ...
            <p className="text-sm text-white leading-relaxed">
              Our machine learning models predict a moderate uptrend for growth
              stocks in the next quarter, driven by expected interest rate
              stability. Specific sectors to watch include renewable energy and
              AI infrastructure. Consider tactical allocations to these areas
              for potential outperformance.
            </p>
            <p className="text-xs text-secondary mt-2">
              Prediction accuracy: 78% for the next 30 days. Model last updated:
              2024-07-20.
            </p>
          </div>
        </Card>
        ...
        <Card title="Risk Shield Summary">
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex items-start gap-2">
                <span className="text-secondary">-</span>Current Beta vs. S&P
                500: 1.15 (slightly aggressive)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-secondary">-</span>Concentration Risk (Top
                5 Holdings): 35%
              </li>
              <li className="flex items-start gap-2">
