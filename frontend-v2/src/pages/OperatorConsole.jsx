...
const MOCK_LOGS = [
  ...
  },
  {
    ...
    timestamp: "14:32:12",
    agent: "MLAgent",
    action: "Pattern detected: Bull Flag",
    ticker: "NVDA",
    confidence: 0.84,
  ...
  },
  {
    ...
    action: "Bullish sentiment surge",
    ticker: "TSLA",
    confidence: 0.81,
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description="Glass House view - see everything, control everything"
      >
          ...
          >
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={
                    agent.profitToday >= 0 ? "text-emerald-400" : "text-red-400"
                  }
                >
