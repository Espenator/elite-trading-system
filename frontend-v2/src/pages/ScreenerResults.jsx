  ...
  return (
    <div className="min-h-full bg-dark text-white space-y-6">
      <PageHeader
        ...
        description="Filter and explore screened symbols"
      >
        <input
          type="text"
          ...
          className="bg-gray-800 border border-gray-700 rounded px-4 py-2 w-80 text-white placeholder-gray-500"
        />
        <button
          type="button"
          className="bg-gray-800 hover:bg-gray-700 border border-gray-700 px-4 py-2 rounded flex items-center gap-2 text-white text-sm"
        >
          <span>⤓</span> Export Data
        </button>
        <button
          type="button"
          className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded flex items-center gap-2 text-white text-sm"
        >
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={assetTypes.futures}
                    onChange={() =>
                      setAssetTypes({
                        ...assetTypes,
                        futures: !assetTypes.futures,
                      })
                    }
                    className="mr-2"
                  />
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={marketCaps.smallCap}
                    onChange={() =>
                      setMarketCaps({
                        ...marketCaps,
                        smallCap: !marketCaps.smallCap,
                      })
                    }
                    className="mr-2"
                  />
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={marketCaps.midCap}
                    onChange={() =>
                      setMarketCaps({
                        ...marketCaps,
                        midCap: !marketCaps.midCap,
                      })
                    }
                    className="mr-2"
                  />
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={marketCaps.largeCap}
                    onChange={() =>
                      setMarketCaps({
                        ...marketCaps,
                        largeCap: !marketCaps.largeCap,
                      })
                    }
                    className="mr-2"
                  />
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={exchanges.nasdaq}
                    onChange={() =>
                      setExchanges({ ...exchanges, nasdaq: !exchanges.nasdaq })
                    }
                    className="mr-2"
                  />
                  <span>NASDAQ</span>
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={exchanges.nyse}
                    onChange={() =>
                      setExchanges({ ...exchanges, nyse: !exchanges.nyse })
                    }
                    className="mr-2"
                  />
                  <span>NYSE</span>
                ...
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={exchanges.amex}
                    onChange={() =>
                      setExchanges({ ...exchanges, amex: !exchanges.amex })
                    }
                    className="mr-2"
                  />
                  <span>AMEX</span>
              ...
              <tbody>
                {stocks.map((stock) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-3 px-2 text-right ${stock.change > 0 ? "text-green-500" : "text-red-500"}`}
                    >
                      {stock.change > 0 ? "+" : ""}
                      {stock.change}%
                    </td>
          ...
          <div className="bg-gray-800/50 rounded-lg p-6 space-y-6">
            ...
            <div>
              ...
              <div className="h-32 flex items-center justify-center bg-gray-900/50 rounded">
                <p className="text-sm text-blue-500">
                  ↗ Miniature Price Chart (Placeholder)
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                AI detects increasing institutional interest and positive news
                sentiment, driving short-term momentum.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-xs text-gray-400 space-y-2">
                <li>
                  • Tech giant announces new chip breakthrough, boosting stock
                  outlook.
                </li>
                <li>
                  • Analysts upgrade rating for company on strong Q3 earnings.
                </li>
                <li>
