...
export default function SettingsPage() {
  ...
  const renderProfile = () => (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Card className="bg-[#0B0E14] border-gray-800 p-4 space-y-3 max-w-xl">
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        {providers.map((p) => {
          ...
          return (
            <Card key={p.id} className="bg-[#0B0E14] border-gray-800 p-4 space-y-3">
              ...
              <div className="flex gap-2">
                {p.source && (
                  <Button variant="secondary" size="xs" onClick={() => onTestConn(p.source)} disabled={cr.testing} className="bg-[#06b6d4]/10 hover:bg-[#06b6d4]/20 text-[#06b6d4] border-[#06b6d4]/20 h-auto text-[10px] py-1 px-3">
        ...
        <Card className="bg-[#0B0E14] border-gray-800 p-4">
          <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mb-2">Alpaca Environment</h4>
          <div className="flex gap-2">
            {["paper", "live"].map((env) => (
  ...
  const renderTradingParams = () => (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Card className="bg-[#0B0E14] border-gray-800 p-4 space-y-3 max-w-xl">
        <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider">Position Sizing</h4>
        ...
        <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mt-4">Trade Management</h4>
        ...
        <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mt-4">Session Hours</h4>
  ...
  const renderAiMl = () => (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Card className="bg-[#0B0E14] border-gray-800 p-4 space-y-3 max-w-xl">
        ...
        <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mt-4">Drift Detection</h4>
  ...
  const renderAgents = () => {
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <Card className="bg-[#0B0E14] border-gray-800 p-4 space-y-3 max-w-xl">
          <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider">Agent Switches</h4>
          {agentToggles.map((a) => (
          ...
          <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mt-4">Operational Limits</h4>
          ...
          <h4 className="text-xs font-bold text-[#06b6d4] uppercase tracking-wider mt-4">OpenClaw Bridge</h4>
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl">
          {sources.map((s) => (
            <Card key={s.key} className="bg-[#0B0E14] border-gray-800 p-4 space-y-3">
              <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              {themes.map((t) => (
                <button key={t} onClick={() => updateField("appearance", "theme", t)}
                  className={`px-3 py-1 text-xs rounded border ${get("appearance", "theme", "dark") === t ? "bg-[#06b6d4] text-black border-[#06b6d4] font-bold" : "border-gray-700 text-gray-400 hover:border-gray-500"}`}>{t}</button>
              ))}
            </div>
          </FieldRow>
            ...
            <div className="flex gap-2">
              {densities.map((d) => (
                <button key={d} onClick={() => updateField("appearance", "density", d)}
                  className={`px-3 py-1 text-xs rounded border ${get("appearance", "density", "compact") === d ? "bg-[#06b6d4] text-black border-[#06b6d4] font-bold" : "border-gray-700 text-gray-400 hover:border-gray-500"}`}>{d}</button>
              ))}
            </div>
          </FieldRow>
            ...
            return (
              <button key={t.key} onClick={() => setActiveTab(t.key)}
                className={`w-full flex items-center gap-2 px-3 py-2 rounded text-xs font-medium transition-colors ${
                  isActive ? "bg-[#06b6d4]/10 text-[#06b6d4] border-l-2 border-[#06b6d4]" : "text-gray-400 hover:text-gray-200 hover:bg-gray-800/50"
                }`}>
