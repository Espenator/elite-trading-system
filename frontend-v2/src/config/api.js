...
const API_CONFIG = {
  ...
  endpoints: {
    ...
    "agents/spawn":   "/agents/spawn",
    "agents/clone":   "/agents/clone",
    "agents/swarm/spawn": "/agents/swarm/spawn",
    "agents/swarm/templates": "/agents/swarm/templates",
    "agents/kill-all": "/agents/kill-all",
