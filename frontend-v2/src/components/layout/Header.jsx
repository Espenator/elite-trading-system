  ...
  const notifications = [
    {
      id: 1,
      type: "signal",
      message: "New bullish pattern detected on AAPL",
      time: "2m ago",
    },
    {
      id: 2,
      type: "trade",
      message: "Trade executed: TSLA Long @ $245.30",
      time: "15m ago",
    },
    {
      id: 3,
      type: "alert",
      message: "Risk threshold exceeded on SPY position",
      time: "1h ago",
    },
    {
      id: 4,
      type: "agent",
      message: "YouTube Agent processed 5 new videos",
      time: "2h ago",
    },
  ];

  return (
    <header className="sticky top-0 z-10 border-b border-secondary/30 h-16 flex items-center justify-between gap-6 px-6 bg-surface">
            ...
            <div className="absolute right-0 mt-2 w-80 rounded-xl bg-dark backdrop-blur-xl border border-secondary/30 shadow-2xl shadow-black/50 overflow-hidden">
              ...
              <div className="max-h-96 overflow-y-auto">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    className="px-4 py-3 hover:bg-white/5 border-b border-white/5 cursor-pointer transition-colors"
                  >
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-56 rounded-xl bg-dark backdrop-blur-xl border border-secondary/30 shadow-2xl shadow-black/50 overflow-hidden">
              ...
              <div className="border-t border-secondary/30 py-2">
                <a
                  href="#"
                  className="flex items-center gap-3 px-4 py-2.5 text-danger hover:bg-danger/10 transition-colors"
                >
