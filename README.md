...
- [x] Fix double `council.verdict` publication (runner.py + council_gate.py) — `council_gate.py:202` (single publish point)
...
- [x] Call SelfAwareness Bayesian tracking (286 lines of dead code) — `runner.py:237-246`
...
- [ ] Establish WebSocket real-time data connectivity (WebSocket code exists, needs frontend integration)
- [x] Wire 12 new Academic Edge agents into runner.py DAG stages — All 12 agents integrated (layered_memory_agent now in Stage 3)
