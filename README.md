...
- [x] Fix double `council.verdict` publication (runner.py + council_gate.py) — `council_gate.py:202`
...
- [x] Call SelfAwareness Bayesian tracking (286 lines of dead code) — `runner.py:237-246`, `main.py:651-684`, `outcome_tracker.py:426-445`
- [x] Call IntelligenceCache.start() at startup — `main.py:729-736`
- [x] Wire brain_service gRPC to hypothesis_agent — `hypothesis_agent.py:21-68`, `critic_agent.py:64-80`
- [ ] Establish WebSocket real-time data connectivity
- [x] Wire 12 new Academic Edge agents into runner.py DAG stages — All 12 agents wired (layered_memory_agent now in Stage 3)
